    ...
    case 'acquisto':
        ...
        if (isset($_SESSION['username'])) {
            ...
            if ($dat >= $totale) {
                ...
                $query = "INSERT INTO `buy` (`simbolo`, `quote`, `prezzo`, `totale`, `dataTransazione`, `tipo`, `email`) VALUES ('" . $simbolo . "', '" . $nAzioni . "', '" . $prezzo . "', '" . $totale . "', '" . $today . "', 'A', '" . $email . "')";
                $res = mysqli_query($mysqli, $query);
                ...
                if ($possdute['quote'] == "") {
                    ...
                    $prezzoMedio = ($possdute['prezzo_medio'] + $prezzo) / 2;
                    $numeroAzioniTotali = $possedute['quote'] + $nAzioni;
                    $totalePortafoglio = $possedute['totale'] + $totale;
