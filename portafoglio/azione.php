        ...
        <div class="container">
            ...
            <div id="head" class="row">
                ...
                if (isset($_SESSION['email']) && $_SESSION['email'] != "") {
                    ...
                    if ($res == "") {
                        echo `<div class="col"><button class="btn btn-primary" onclick="./api/index.php?action=AggiungiPreferito&simbolo=$simbolo">
                        ...
                        echo `<div class="col"><button class="btn btn-primary" onclick="./api/index.php?action=RimuoviPreferito&simbolo=$simbolo">
